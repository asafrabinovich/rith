                ...
                <div className="collapse navbar-collapse rtl" id="navbarNav">
                    <ul className="navbar-nav">
                        <li className="nav-item rtl ">
                            <NavLink className="nav-link" to="/">RITH<span className="sr-only"></span></NavLink>
                        </li>
                        <li className="nav-item rtl ">
                            <NavLink className="nav-link" to="/">חיפוש דירה<span className="sr-only"></span></NavLink>
                        </li>
                        <li className="nav-item rtl ">
                            <NavLink className="nav-link" to="/upload-review">העלה ביקורת<span
                                className="sr-only"></span></NavLink>
                        </li>
                        <li className="nav-item rtl">
